...
const TAB_ITEMS = [
  ...
  { value: "integrationSettings", label: "Integration Settings" },
  { value: "notificationPreference", label: "Notification Preference" },
];
  ...
  return (
    <div className="flex flex-col gap-4 w-full h-full">
      ...
      <div className="z-50 p-4 w-full h-full bg-white/75 dark:bg-[#001434A6] rounded-2xl shadow-sm">
        <Tabs defaultValue="accountSettings" className="w-full">
          <TabsList
            className="
            h-12
