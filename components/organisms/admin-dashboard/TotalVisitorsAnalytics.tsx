 ...
 *
 * Displays an interactive area chart showing visitor data for different time ranges.
 * All texts and labels are localized using `next-intl`.
 *
 * @component
...
export function TotalVisitorsAnalytics() {
  ...
  return (
    <Card className="pt-0 bg-[#FFFFFFBF] dark:bg-[#001434A6]">
