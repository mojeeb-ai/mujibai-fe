...
/**
 * Columns are defined here so they can reference small components.
 * Keep them stable (memoized) to avoid unnecessary re-renders.
 */
const buildColumns = (CheckboxComponent: any): ColumnDef<Item, any>[] => [
  {
    id: "drag",
    header: () => null,
      ...
      <div>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-32">
            ...
            <DropdownMenuCheckboxItem>Make a copy</DropdownMenuCheckboxItem>
            <DropdownMenuCheckboxItem>Favorite</DropdownMenuCheckboxItem>
            <DropdownMenuSeparator />
...
export function AdminOverviewTable({ data: initialData }: { data: Item[] }) {
  ...
  const columns = React.useMemo(() => buildColumns(Checkbox), []);
